...
public class KeyUtils {
    public static void readPEM() {
        readPEMPublicKey();
        //readPEMPrivateKey();
    }

    public static void readPEMPrivateKey() {
    ...
    public static void readPEMPublicKey() {
    ...
    public static void generateECC() throws NoSuchAlgorithmException, NoSuchProviderException {
